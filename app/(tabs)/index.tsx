...
export default function HomePage() {
  ...
  const localParams = useLocalSearchParams<{ tagId?: string | string[] }>();
  const globalParams = useGlobalSearchParams<{ tagId?: string | string[] }>();
            ...
            <Box mb={1}>
              <HStack space={2} alignItems="center">
                <Image
                  source={{
                    uri:
                      "https://retroranker.site/logos/retro-ranker/rr-logo.png",
                  }}
